...
use App\Models\EvidenciaUsoMlConfig;
...
class EvidenciasUsoMlController extends Controller
{
    public function index(): View
    {
        ...
        return view('orc-mlstd.evidencias-uso', [
    ...
    public function updateTempos(Request $request): RedirectResponse
    {
        $validated = $request->validate([
            ...
            'tempo_levantamento_ele_min.numeric' => 'O tempo de ELE deve ser numérico.',
            ...
            'tempo_levantamento_tub_min.numeric' => 'O tempo de TUB deve ser numérico.',
        ...
        return redirect()
            ->route('orc-mlstd.evidencias-uso.index')
            ->with('success', 'Tempos médios atualizados com sucesso.');
    }
    ...
    private function refreshEvidenceItemCounts(): void
    {
        ...
        $rows = OrcMLstd::query()
            ->joinSub($statsByOrc, 'st', function ($join) {
